...
namespace GMUFFCommon
{
    ...
    {
        public static void ReduceImagesQuality(string sourcePath, int rate = 50)
        {
        ...
        public static Image JoinImages(string imageFolder, int hour = -1, int minute = -1, int second = -1)
        {
            ...
            if (hour != -1)
            {
                ...
                {
                    int index = FileNameUtil.GetBlockIndexFromFileName(files[i]);
        ...
        private static List<GeoBlockPosition> InitGeoBlockPositionTable()
        {
